...
<div class="portlet light">
    ...
    <div class="portlet-body">
        {!! Form::open(['route' => ['admin.submission.update', $submission->id], 'method' => 'put']) !!}
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        {{ Form::label('organization', 'Organization Name') }}
                        {{ Form::select('organization', $organizations, $submission->organization_id, ['class' => 'form-control', 'placeholder' => 'Select Organization']) }}
                    </div>
                </div>
            </div>
            <div class="row">
